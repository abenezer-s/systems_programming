...
void main(void){
// sample run data
    int i,f,v,r, re,z,x,m,n, k ,val1, val2, val3, val4;
    i = 5;
    f = 6;
    v = 7;
    r = 8;
...
//put
    ...
    SymTable_put(s, "key7", &x);
    SymTable_put(s, "key8", &m);
    SymTable_put(s, "key9", &n);
    SymTable_put(s, "key10", &k);
    SymTable_put(s, "key10", &k);
    SymTable_put(s, "key10", &k);
